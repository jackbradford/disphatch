...
class Output {
	...
	public function setContent($content) {
		...
		if (!isset($content)) {
			...
			$m	=	__METHOD__ . ' Missing Argument: expects $content.';
			throw new BadMethodCallException($m, 403);
		}
